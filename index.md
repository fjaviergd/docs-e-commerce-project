# eBay API Integration — GTS CRM (v1)

Documentación de todas las APIs de eBay consumidas por `crm-api_nest` en el flujo de creación de listings. Los documentos están ordenados según la secuencia de uso.
...
*Este documento se irá actualizando conforme se agreguen los endpoints de v2.*
